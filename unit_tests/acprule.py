...
def test__acp_rule(fmc):
    ...
    # Test port literals (Issue #96)
    acprule1.source_port(action="add", literal="1024-65535", protocol="TCP")
    acprule1.destination_port(action="add", literal="80", protocol="TCP")
    acprule1.destination_port(action="add", literal="443", protocol="TCP")
    acprule1.destination_port(action="add", literal="53", protocol="UDP")
