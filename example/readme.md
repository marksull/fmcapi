...
You can find that code in the [mixed_logic_and_data](https://github.com/daxm/fmcapi/tree/master/example/mixed_logic_and_data) directory.
Pros:
...
You can find that code example in the [logic_separate_from_data](https://github.com/daxm/fmcapi/tree/master/example/logic_separate_from_data) directory.  (The program_logic.py is the Python
 script to run.  
