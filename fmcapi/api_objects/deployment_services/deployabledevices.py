...
class DeployableDevices(object):  # Can't import APIClassTemplate due to dependency loop.
    """
    ...
    def __init__(self, fmc):
        ...
        logging.info(f"Waiting {self.WAIT_TIME} seconds to allow the FMC to update the list of deployable devices.")
