...
class AdvancedSettings(APIClassTemplate):
	...
	VALID_JSON_DATA = ['id', 'name', 'type', 'advancedIkeSetting', 'advancedTunnelSetting', 'advancedIpsecSetting', 'version']
	...
	def parse_kwargs(self, **kwargs):
	    ...
	    logging.debug("In parse_kwargs() for AdvancedSettings class.")
	...
	def vpn_policy(self, pol_name):
		...
		if 'id' in ftd_s2s.__dict__:
		    ...
		    logging.warning(f'FTD S2S VPN Policy "{name}" not found.  Cannot set up AdvancedSettings for FTDS2SVPNs Policy.')
