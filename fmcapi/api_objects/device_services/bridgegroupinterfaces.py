...
class BridgeGroupInterfaces(APIClassTemplate):
    ...
    VALID_JSON_DATA = ['id', 'name', 'type', 'mode', 'enabled', 'MTU', 'managementOnly', 'ipAddress',
                       'selectedInterfaces', 'bridgeGroupId', 'macLearn', 'ifname', 'securityZone', 'arpConfig', 'ipv4',
                       'ipv6', 'macTable', 'enableAntiSpoofing', 'fragmentReassembly', 'enableDNSLookup',
                       'activeMACAddress', 'standbyMACAddress',
                       ]
